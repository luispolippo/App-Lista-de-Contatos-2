...
class ContactAdapter: RecyclerView.Adapter<ContactAdapter.ContactAdpterViewHolder>() {

    private val list: MutableList<Contact> = mutableListOf()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContactAdpterViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.contact_item, parent, false)
        return ContactAdpterViewHolder(view)
    }
    ...
    class ContactAdpterViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
